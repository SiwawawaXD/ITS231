...
public class QueueApp {
	...
	static String prefixEval(String[] input) {
		...
		// add your code here
		Node<String> tmp;
		String x = Q.list.first.element;
		String y = Q.list.first.next.element;
		String z = Q.list.first.next.next.element;
		while(Q.list.size >= 3) {
			x = Q.list.first.element;
			y = Q.list.first.next.element;
			z = Q.list.first.next.next.element;
